...
namespace Autodesk.DataManagement.Http
{
    ...
    public interface IFoldersApi
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<Folder>> CreateFolderAsync (string projectId, string xUserId= default(string), CreateFolder createFolder= default(CreateFolder),  string accessToken = null, bool throwOnError = true);
        /// <summary>
        ...
        System.Threading.Tasks.Task<HttpResponseMessage> CreateFolderRelationshipsRefAsync (string folderId, string projectId, string xUserId= default(string), RelationshipRefsRequest relationshipRefsRequest= default(RelationshipRefsRequest),  string accessToken = null, bool throwOnError = true);
        /// <summary>
        ...
        System.Threading.Tasks.Task<ApiResponse<Folder>> PatchFolderAsync (string projectId, string folderId, string xUserId= default(string), ModifyFolder modifyFolder= default(ModifyFolder),  string accessToken = null, bool throwOnError = true);
    }
    ...
    public partial class FoldersApi : IFoldersApi
    {
        ...
        public async System.Threading.Tasks.Task<ApiResponse<Folder>> CreateFolderAsync (string projectId,string xUserId= default(string),CreateFolder createFolder= default(CreateFolder), string accessToken = null, bool throwOnError = true)
        {
            ...
            using (var request = new HttpRequestMessage())
            {
                ...
                request.Content = Marshalling.Serialize(createFolder); // http body (model) parameter
        ...
        public async System.Threading.Tasks.Task<ApiResponse<Folder>> PatchFolderAsync (string projectId,string folderId,string xUserId= default(string),ModifyFolder modifyFolder= default(ModifyFolder), string accessToken = null, bool throwOnError = true)
        {
            ...
            using (var request = new HttpRequestMessage())
            {
                ...
                request.Content = Marshalling.Serialize(modifyFolder); // http body (model) parameter
