...
namespace Autodesk.DataManagement.Http
{
    ...
    public interface IItemsApi
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<Item>> CreateItemAsync (string projectId, string xUserId= default(string), string copyFrom= default(string), CreateItem createItem= default(CreateItem),  string accessToken = null, bool throwOnError = true);
        /// <summary>
        ...
        System.Threading.Tasks.Task<HttpResponseMessage> CreateItemRelationshipsRefAsync (string projectId, string itemId, string xUserId= default(string), RelationshipRefsRequest relationshipRefsRequest= default(RelationshipRefsRequest),  string accessToken = null, bool throwOnError = true);
        /// <summary>
        ...
        System.Threading.Tasks.Task<ApiResponse<Item>> PatchItemAsync (string projectId, string itemId, string xUserId= default(string), ItemRequest itemRequest= default(ItemRequest),  string accessToken = null, bool throwOnError = true);
    }
    ...
    public partial class ItemsApi : IItemsApi
    {
        ...
        public async System.Threading.Tasks.Task<ApiResponse<Item>> CreateItemAsync (string projectId,string xUserId= default(string),string copyFrom= default(string),CreateItem createItem= default(CreateItem), string accessToken = null, bool throwOnError = true)
        {
            ...
            using (var request = new HttpRequestMessage())
            {
                ...
                request.Content = Marshalling.Serialize(createItem); // http body (model) parameter
        ...
        public async System.Threading.Tasks.Task<ApiResponse<Item>> PatchItemAsync (string projectId,string itemId,string xUserId= default(string),ItemRequest itemRequest= default(ItemRequest), string accessToken = null, bool throwOnError = true)
        {
            ...
            using (var request = new HttpRequestMessage())
            {
                ...
                request.Content = Marshalling.Serialize(itemRequest); // http body (model) parameter
