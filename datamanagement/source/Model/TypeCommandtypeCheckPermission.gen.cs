...
namespace Autodesk.DataManagement.Model
{
    ...
    /// </summary>
    ///<value>The Type ID of the schema used for extending properties. Must be `commands:autodesk.core:CheckPermission` for the CheckPermission command.</value>
    
    [JsonConverter(typeof(StringEnumConverter))]
    
    public enum TypeCommandtypeCheckPermission
    {
