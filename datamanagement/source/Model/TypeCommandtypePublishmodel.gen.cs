...
namespace Autodesk.DataManagement.Model
{
    ...
    /// </summary>
    ///<value>The Type ID of the schema used for extending properties. Must be `commands:autodesk.bim360:C4RModelPublish` for the PublishModel command.</value>
    
    [JsonConverter(typeof(StringEnumConverter))]
    
    public enum TypeCommandtypePublishmodel
    {
