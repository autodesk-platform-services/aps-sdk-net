...
namespace Autodesk.DataManagement.Model
{
    ...
    /// </summary>
    ///<value>The Type ID of the schema used for extending properties. Must be `commands:autodesk.bim360:C4RPublishWithoutLinks` for the PublishWithoutLinks command.</value>
    
    [JsonConverter(typeof(StringEnumConverter))]
    
    public enum TypeCommandtypePublishWithoutLinks
    {
