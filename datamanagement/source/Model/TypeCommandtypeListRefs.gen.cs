...
namespace Autodesk.DataManagement.Model
{
    ...
    /// </summary>
    ///<value>The Type ID of the schema used for extending properties. Must be `commands:autodesk.core:ListRefs` for the ListRefs command.</value>
    
    [JsonConverter(typeof(StringEnumConverter))]
    
    public enum TypeCommandtypeListRefs
    {
