...
namespace Autodesk.DataManagement.Model
{
    ...
    /// </summary>
    ///<value>The Type ID of the schema used for extending properties. Must be `commands:autodesk.core:ListItems` for the ListItems command.</value>
    
    [JsonConverter(typeof(StringEnumConverter))]
    
    public enum TypeCommandtypeListItems
    {
