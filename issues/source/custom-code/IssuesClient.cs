...
namespace Autodesk.Constructionissues
{
        public class IssuesClient
        {
                ...
                public async System.Threading.Tasks.Task<CreatedComment> CreateCommentsAsync (string projectId, string issueId, XAdsRegion xAdsRegion,CommentsPayload commentsPayload= default(CommentsPayload),  string accessToken = null, bool throwOnError = true){
                ...
                public async System.Threading.Tasks.Task<Comments> GetCommentsAsync (string projectId, string issueId, XAdsRegion xAdsRegion, string limit= default(string), string offset= default(string), List<SortBy> sortBy= default(List<SortBy>),  string accessToken = null, bool throwOnError = true){
                ...
                public async System.Threading.Tasks.Task<IssueRootCause> GetRootCauseCategoriesAsync (string projectId, XAdsRegion xAdsRegion, string include= default(string), int? limit= default(int?), int? offset= default(int?), string filterUpdatedAt= default(string),  string accessToken = null, bool throwOnError = true){
                ...
                public async System.Threading.Tasks.Task<Issue> CreateIssueAsync (string projectId, XAdsRegion xAdsRegion, IssuePayload issuePayload= default(IssuePayload),  string accessToken = null, bool throwOnError = true){
                ...
                public async System.Threading.Tasks.Task<Issue> GetIssueDetailsAsync (string projectId, string issueId, XAdsRegion xAdsRegion,  string accessToken = null, bool throwOnError = true){
                ...
                public async System.Threading.Tasks.Task<Issue> PatchIssueDetailsAsync (string projectId, string issueId, XAdsRegion xAdsRegion, IssuePayload issuePayload= default(IssuePayload),  string accessToken = null, bool throwOnError = true){
                        var response = await this.PatchIssueDetailsAsync (projectId, issueId,xAdsRegion, issuePayload,  accessToken,throwOnError);
                        return response;
                ...
                public async System.Threading.Tasks.Task<User> GetUserProfileAsync (string projectId, XAdsRegion xAdsRegion,  string accessToken = null, bool throwOnError = true){
                ...
                public async System.Threading.Tasks.Task<IssueType> GetIssuesTypesAsync (string projectId, XAdsRegion xAdsRegion, string include= default(string), int? limit= default(int?), int? offset= default(int?), string filterUpdatedAt= default(string), bool? filterIsActive= default(bool?),  string accessToken = null, bool throwOnError = true){
                        var response = await this.IssueTypesApi.GetIssuesTypesAsync (projectId, xAdsRegion, include,  limit,  offset, filterUpdatedAt,  filterIsActive,  accessToken , throwOnError);
                        return response.Content;
                }
        }
