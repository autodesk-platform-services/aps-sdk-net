...
namespace Autodesk.Construction.Issues.Http
{
    ...
    public interface IIssuesProfileApi
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<User>> GetUserProfileAsync(string projectId, Region? xAdsRegion = null, string accessToken = null, bool throwOnError = true);
    }
    ...
    public partial class IssuesProfileApi : IIssuesProfileApi
    {
        ...
        public async System.Threading.Tasks.Task<ApiResponse<User>> GetUserProfileAsync(string projectId, Region? xAdsRegion = null, string accessToken = null, bool throwOnError = true)
        {
