...
HookCreationResult createAllEventsHooks = await _webhooksApi.CreateSystemHookAsync(system: Systems.Derivative, hookPayload: createAllEventsHook, accessToken: token);
