...
namespace Autodesk.Construction.Issues
{
        public class IssuesClient
        {
                ...
                public async System.Threading.Tasks.Task<CreatedComment> CreateCommentsAsync(string projectId, string issueId, Region xAdsRegion, CommentsPayload commentsPayload = default(CommentsPayload), string accessToken = null, bool throwOnError = true)
                {
                ...
                public async System.Threading.Tasks.Task<Comments> GetCommentsAsync(string projectId, string issueId, Region xAdsRegion, string limit = default(string), string offset = default(string), List<SortBy> sortBy = default(List<SortBy>), string accessToken = null, bool throwOnError = true)
                {
                ...
                public async System.Threading.Tasks.Task<IssueRootCause> GetRootCauseCategoriesAsync(string projectId, Region xAdsRegion, string include = default(string), int? limit = default(int?), int? offset = default(int?), string filterUpdatedAt = default(string), string accessToken = null, bool throwOnError = true)
                {
                ...
                public async System.Threading.Tasks.Task<Issue> CreateIssueAsync(string projectId, Region xAdsRegion, IssuePayload issuePayload = default(IssuePayload), string accessToken = null, bool throwOnError = true)
                {
                ...
                public async System.Threading.Tasks.Task<Issue> GetIssueDetailsAsync(string projectId, string issueId, Region xAdsRegion, string accessToken = null, bool throwOnError = true)
                {
                ...
                public async System.Threading.Tasks.Task<Issue> PatchIssueDetailsAsync(string projectId, string issueId, Region xAdsRegion, IssuePayload issuePayload = default(IssuePayload), string accessToken = null, bool throwOnError = true)
                {
                ...
                public async System.Threading.Tasks.Task<User> GetUserProfileAsync(string projectId, Region xAdsRegion, string accessToken = null, bool throwOnError = true)
                {
                ...
                public async System.Threading.Tasks.Task<IssueType> GetIssuesTypesAsync(string projectId, Region xAdsRegion, string include = default(string), int? limit = default(int?), int? offset = default(int?), string filterUpdatedAt = default(string), bool? filterIsActive = default(bool?), string accessToken = null, bool throwOnError = true)
                {
