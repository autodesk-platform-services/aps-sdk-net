...
namespace Autodesk.Construction.Issues
{
        public class IssuesClient : BaseClient
        {
                ...
                public async System.Threading.Tasks.Task<CreatedComment> CreateCommentsAsync(string projectId, string issueId, CommentsPayload commentsPayload, Region xAdsRegion = default, string accessToken = null, bool throwOnError = true)
                {
                        if (String.IsNullOrEmpty(accessToken) && this.AuthenticationProvider == null)
                        {
                                throw new Exception("Please provide a valid access token or an authentication provider");
                ...
                public async System.Threading.Tasks.Task<Comments> GetCommentsAsync(string projectId, string issueId, Region xAdsRegion = default, string limit = default(string), string offset = default(string), List<SortBy> sortBy = default(List<SortBy>), string accessToken = null, bool throwOnError = true)
                {
                        if (String.IsNullOrEmpty(accessToken) && this.AuthenticationProvider == null)
                        {
                                throw new Exception("Please provide a valid access token or an authentication provider");
                ...
                public async System.Threading.Tasks.Task<IssueRootCause> GetRootCauseCategoriesAsync(string projectId, Region xAdsRegion = default, string include = default(string), int? limit = default(int?), int? offset = default(int?), string filterUpdatedAt = default(string), string accessToken = null, bool throwOnError = true)
                {
                        if (String.IsNullOrEmpty(accessToken) && this.AuthenticationProvider == null)
                        {
                                throw new Exception("Please provide a valid access token or an authentication provider");
                ...
                public async System.Threading.Tasks.Task<Issue> CreateIssueAsync(string projectId, IssuePayload issuePayload, Region xAdsRegion = default, string accessToken = null, bool throwOnError = true)
                {
                        if (String.IsNullOrEmpty(accessToken) && this.AuthenticationProvider == null)
                        {
                                throw new Exception("Please provide a valid access token or an authentication provider");
                ...
                public async System.Threading.Tasks.Task<Issue> GetIssueDetailsAsync(string projectId, string issueId, Region xAdsRegion = default, string accessToken = null, bool throwOnError = true)
                {
                        if (String.IsNullOrEmpty(accessToken) && this.AuthenticationProvider == null)
                        {
                                throw new Exception("Please provide a valid access token or an authentication provider");
                ...
                public async System.Threading.Tasks.Task<User> GetUserProfileAsync(string projectId, Region xAdsRegion = default, string accessToken = null, bool throwOnError = true)
                {
                        if (String.IsNullOrEmpty(accessToken) && this.AuthenticationProvider == null)
                        {
                                throw new Exception("Please provide a valid access token or an authentication provider");
                ...
                public async System.Threading.Tasks.Task<IssueType> GetIssuesTypesAsync(string projectId, string include = default(string), int? limit = default(int?), int? offset = default(int?), string filterUpdatedAt = default(string), bool? filterIsActive = default(bool?), Region xAdsRegion = default, string accessToken = null, bool throwOnError = true)
                {
                        if (String.IsNullOrEmpty(accessToken) && this.AuthenticationProvider == null)
                        {
                                throw new Exception("Please provide a valid access token or an authentication provider");
