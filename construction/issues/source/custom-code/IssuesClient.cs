...
namespace Autodesk.Construction.Issues
{
        public class IssuesClient
        {
                ...
                public IssuesClient(SDKManager.SDKManager sdkManager)
                {
                ...
                public async System.Threading.Tasks.Task<AttrDefinition> GetAttributeDefinitionsAsync(string accessToken, string projectId, Region xAdsRegion, int? limit = default(int?), int? offset = default(int?), string filterCreatedAt = default(string), string filterUpdatedAt = default(string), string filterDeletedAt = default(string), List<DataType> filterDataType = default(List<DataType>), bool throwOnError = true)
                {
                ...
                public async System.Threading.Tasks.Task<CreatedComment> CreateCommentsAsync(string accessToken, string projectId, string issueId, Region xAdsRegion, CommentsPayload commentsPayload , bool throwOnError = true)
                {
                ...
                public async System.Threading.Tasks.Task<Comments> GetCommentsAsync(string accessToken, string projectId, string issueId, Region xAdsRegion, string limit = default(string), string offset = default(string), List<SortBy> sortBy = default(List<SortBy>), bool throwOnError = true)
                {
                ...
                public async System.Threading.Tasks.Task<IssueRootCause> GetRootCauseCategoriesAsync(string accessToken, string projectId, Region xAdsRegion, string include = default(string), int? limit = default(int?), int? offset = default(int?), string filterUpdatedAt = default(string), bool throwOnError = true)
                {
                ...
                public async System.Threading.Tasks.Task<Issue> CreateIssueAsync(string accessToken, string projectId, Region xAdsRegion, IssuePayload issuePayload, bool throwOnError = true)
                {
                ...
                public async System.Threading.Tasks.Task<Issue> GetIssueDetailsAsync(string accessToken, string projectId, string issueId, Region xAdsRegion, bool throwOnError = true)
                {
                ...
                public async System.Threading.Tasks.Task<Issue> PatchIssueDetailsAsync(string accessToken, string projectId, string issueId, Region xAdsRegion, IssuePayload issuePayload, bool throwOnError = true)
                {
                        var response = await this.PatchIssueDetailsAsync(accessToken,projectId, issueId, xAdsRegion, issuePayload, throwOnError);
                        return response;
                ...
                public async System.Threading.Tasks.Task<User> GetUserProfileAsync(string accessToken, string projectId, Region xAdsRegion, bool throwOnError = true)
                {
                ...
                public async System.Threading.Tasks.Task<IssueType> GetIssuesTypesAsync(string accessToken, string projectId, Region xAdsRegion, string include = default(string), int? limit = default(int?), int? offset = default(int?), string filterUpdatedAt = default(string), bool? filterIsActive = default(bool?), bool throwOnError = true)
                {
