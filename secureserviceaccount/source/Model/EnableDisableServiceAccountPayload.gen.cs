...
namespace Autodesk.SecureServiceAccount.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EnableDisableServiceAccountPayload
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnableDisableServiceAccountPayload" /> class.
        /// </summary>
        public EnableDisableServiceAccountPayload()
        {
        }
