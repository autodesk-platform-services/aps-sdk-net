...
namespace Autodesk.SecureServiceAccount.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EnableDisableServiceAccountKeyPayload
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnableDisableServiceAccountKeyPayload" /> class.
        /// </summary>
        public EnableDisableServiceAccountKeyPayload()
        {
        }
