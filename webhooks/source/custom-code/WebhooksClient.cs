...
namespace Autodesk.Webhooks
{
    public class WebhooksClient
    {
        ...
        public async System.Threading.Tasks.Task<HttpResponseMessage> CreateSystemEventHookAsync(Systems system, Events _event, XAdsRegion? xAdsRegion= null, Region? region= null, HookPayload hookPayload = default(HookPayload), string accessToken = null, bool throwOnError = true)
        {
        ...
        public async System.Threading.Tasks.Task<Hook> CreateSystemHookAsync(Systems system, XAdsRegion? xAdsRegion= null, Region? region= null, HookPayload hookPayload = default(HookPayload), string accessToken = null, bool throwOnError = true)
        {
        ...
        public async System.Threading.Tasks.Task<Hooks> GetAppHooksAsync(XAdsRegion? xAdsRegion= null, Region? region= null, string pageState = default(string), string status = default(string), string sort = default(string), string accessToken = null, bool throwOnError = true)
        {
        ...
        public async System.Threading.Tasks.Task<HookDetails> GetHookDetailsAsync(Systems system, Events _event, string hookId, XAdsRegion? xAdsRegion= null, Region? region= null, string accessToken = null, bool throwOnError = true)
        {
        ...
        public async System.Threading.Tasks.Task<Hooks> GetHooksAsync(string pageState = default(string), string status = default(string), XAdsRegion? xAdsRegion= null, Region? region= null, string accessToken = null, bool throwOnError = true)
        {
        ...
        public async System.Threading.Tasks.Task<Hooks> GetSystemEventHooksAsync(Systems system, Events _event, XAdsRegion? xAdsRegion= null, Region? region= null, string scopeName = default(string), string pageState = default(string), string status = default(string), string accessToken = null, bool throwOnError = true)
        {
        ...
        public async System.Threading.Tasks.Task<Hooks> GetSystemHooksAsync(Systems system, XAdsRegion? xAdsRegion= null, Region? region= null, string status = default(string), string pageState = default(string), string accessToken = null, bool throwOnError = true)
        {
        ...
        public async System.Threading.Tasks.Task<Token> CreateTokenAsync(XAdsRegion? xAdsRegion= null, Region? region= null, TokenPayload tokenPayload = default(TokenPayload), string accessToken = null, bool throwOnError = true)
        {
